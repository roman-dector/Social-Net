...
type MapDispatchToPropsType = {
  getUserProfileInfo: (id: number) => Promise<void>
  getUserStatus: (id: number) => Promise<void>
  updateLoggedUserPhoto: (photo: File) => void
  toggleIsFetchingProfileInfo: (status: boolean) => void
  toggleIsFetchingProfileStatus: (status: boolean) => void
}

const Profile: FC<MapStateToPropsType & MapDispatchToPropsType> = props => {
